...
public class ElasticsearchTests {
    ...
    public void testInsert() {
        ...
        discussPostRepository.save(discussPostMapper.selectDiscussPostById(12));
        discussPostRepository.save(discussPostMapper.selectDiscussPostById(13));
    }

    @Test
    public void testUpdate() {
        discussPostRepository.save(discussPostMapper.selectDiscussPostById(25));
        DiscussPost post = discussPostMapper.selectDiscussPostById(25);
    ...
    public void testInsertList() {
        discussPostRepository.saveAll(discussPostMapper.selectDiscussPosts(1, 0, 100));
        discussPostRepository.saveAll(discussPostMapper.selectDiscussPosts(2, 0, 100));
        discussPostRepository.saveAll(discussPostMapper.selectDiscussPosts(3, 0, 100));
    }
    ...
    public void testSearchByRepository() {
        ...
        NativeSearchQuery searchQuery =
                new NativeSearchQueryBuilder()
                        .withQuery(QueryBuilders.multiMatchQuery("沈阳", "title", "content"))
